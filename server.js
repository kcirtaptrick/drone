...
const motor = [new pio(24, {mode: pio.OUTPUT}), new pio(27, {mode: pio.OUTPUT})];
...
io.on('connection', function(socket){
    ...
    socket.on('gamepadState', (state) => {
        ...
        // console.log('Motor 1: ' + (1000 + postUp + calc(control.pitch, false) + calc(control.roll, false)).toFixed(0));
        // console.log('Motor 2: ' + (1000 + postUp + calc(control.pitch, false) - calc(control.roll, true)).toFixed(0));
        // console.log('Motor 3: ' + (1000 + postUp - calc(control.pitch, true) - calc(control.roll, true)).toFixed(0));
        // console.log('Motor 4: ' + (1000 + postUp - calc(control.pitch, true) + calc(control.roll, false)).toFixed(0));
        console.log(state);
    });
});
